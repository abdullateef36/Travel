...
import ExperienceData from "./components/ExperienceData"; // <--- Import ExperienceData
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        {hasCheckmark && <FiCheck className="text-white text-3xl mb-2" />}
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="px-4 md:px-8 py-6 md:py-12 max-w-5xl mx-auto">
        ...
        {/* <-- This is where we link our backend via the ExperienceData component */}
        <div className="mt-10">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">Dynamic Experiences</h2>
          <ExperienceData />
        </div>
      </main>
